...
class Alipay extends IPay {
    ...
    //回调地址
    public $notifyUrl='http://member.qa.lookmanhua.com/notify/alipay';
     ...
     * @author guofa.tgf
     */
    private function sdkExecute($goods) {
        $params['app_id'] = $this->appId;
    ...
    //生成扫码支付预付款订单
    private function execute($goods, $authToken = null, $appInfoAuthtoken = null) {
        //组装系统参数
    ...
    */
    ...
    function verify($data, $sign) {
        ...
        if ("RSA2" == $signType) {
            b('$signType1',$signType);
            $result = (bool)openssl_verify($data, base64_decode($sign), $res, OPENSSL_ALGO_SHA256);
        }
        else {
            b('$signType2',$signType);
